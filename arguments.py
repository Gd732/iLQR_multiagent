...
def add_arguments(parser):
    ...
    parser.add_argument('--w_pos', type=float, default=2.5, help="Path deviation cost")
    ...
    parser.add_argument('--acc_limits', nargs="*", type=float, default=[-5.0, 5.0], help="Acceleration limits for the agent vehicle (min,max)")
    ...
    parser.add_argument('--max_speed', type=float, default=50.0, help="Ego Vehicle's max speed")
    ...
    parser.add_argument('--car_dims', nargs="*", type=float, default=[4.0, 2.0], help="Acceleration control input limits (min,max)")
